...
- Each rule is implemented as written: BUY fee capitalized, SELL fee off proceeds, SELL keeps the average, full close removes the whole remaining cost basis, no short sale accepted.
