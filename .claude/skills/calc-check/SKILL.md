...
6. **API output**, when the serializer changed: amounts are plain notation (no `1e-8`), at most 20 decimal places, and `summary.totalPnl` for the sample is `-4401.3084972465`.
